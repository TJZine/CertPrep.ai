...
export function DashboardSkeleton({
  ...
  return (
    <DashboardShell
      ...
      srsSlot={
        <div
          data-testid="dashboard-skeleton-srs-grid"
...
function QuizCardSkeleton(): React.ReactElement {
  return (
    <Card
      ...
      className="dashboard-card flex h-full flex-col"
      aria-hidden="true"
    >
      <CardHeader className="pb-4">
        <div className="space-y-2">
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border bg-card px-6 py-10 text-center">
      ...
      <p className="mt-2 max-w-md text-sm text-muted-foreground">
        Import your first quiz to get started. Upload a JSON file or paste quiz
        data.
      </p>
    </div>
  );
