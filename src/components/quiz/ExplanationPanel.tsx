    ...
    <div className={cn('', className)}>
      ...
      {isExpanded && (
        <Card
          ...
          className={cn('mt-2', isCorrect ? 'border-green-200 bg-green-50' : 'border-amber-200 bg-amber-50')}
        >
          <CardContent className="p-4">
            <div className="space-y-4">
              <div>
                ...
                <div
                  className={cn('prose prose-sm max-w-none', isCorrect ? 'prose-green' : 'prose-amber')}
