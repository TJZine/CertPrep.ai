...
import { AlertTriangle, CheckCircle, Flag, HelpCircle, Send } from 'lucide-react';
    ...
    <Modal
      ...
      footer={
        <>
          ...
          <Button variant={isReady ? 'success' : 'default'} onClick={onConfirm} isLoading={isSubmitting} leftIcon={<Send className="h-4 w-4" />}>
            Submit Exam
          </Button>
        </>
      }
          ...
          <div className="flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50 p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-amber-700">
                ...
                {!noFlagged ? (
                  <>
                    You have {flaggedCount} flagged question{flaggedCount !== 1 ? 's' : ''} you may want to review.
                  </>
                ) : null}
              </p>
            </div>
...
export function TimeUpModal({
  ...
  return (
    <Modal
      ...
      footer={
        <Button variant="default" onClick={onConfirm} isLoading={isSubmitting} className="w-full">
          View Results
        </Button>
      }
    >
