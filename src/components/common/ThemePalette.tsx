...
export function ThemePalette(): React.ReactElement {
    ...
    return (
        <div className="relative" ref={containerRef}>
            ...
            {isOpen && (
                <div className="absolute right-0 top-full z-[10000] w-72 rounded-xl border border-border bg-popover/95 p-2 shadow-lg backdrop-blur-md animate-in fade-in zoom-in-95 duration-150">
