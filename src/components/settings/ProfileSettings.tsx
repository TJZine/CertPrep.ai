      ...
      <CardContent>
        <form onSubmit={handleUpdateProfile} className="space-y-4">
          <div className="space-y-2">
            <label htmlFor="email" className="text-sm font-medium leading-none flex justify-between">
              <span>Email</span>
              {!isEditingEmail && (
                <button
                  type="button"
            ...
            <div className="relative">
              <Input
                ...
                className={!isEditingEmail ? "bg-slate-100 dark:bg-slate-800 text-slate-500" : ""}
              />
              {!isEditingEmail && (
