        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="grid w-full max-w-md grid-cols-3 gap-4">
            <div className="rounded-lg bg-white/50 p-3">
              <Clock className="mx-auto mb-1 h-5 w-5 text-slate-500" aria-hidden="true" />
              <p className="text-lg font-semibold text-slate-900">{formatTime(timeTakenSeconds)}</p>
              <p className="text-xs text-slate-500">Duration</p>
            </div>

            <div className="rounded-lg bg-white/50 p-3">
              <Target className="mx-auto mb-1 h-5 w-5 text-slate-500" aria-hidden="true" />
              <p className="text-lg font-semibold capitalize text-slate-900">{mode}</p>
              <p className="text-xs text-slate-500">Mode</p>
            </div>

            <div className="rounded-lg bg-white/50 p-3">
              <Calendar className="mx-auto mb-1 h-5 w-5 text-slate-500" aria-hidden="true" />
              <p className="text-lg font-semibold text-slate-900">{formatDate(timestamp)}</p>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        ...
        <p className="mt-1 text-sm text-slate-600">Completed in {formatTime(timeTakenSeconds)}</p>
      </div>
